...
class TrapezoidComponent {
 public:
  ...
  using Input = A2D::VarTuple<T1, T1, T1, T1, T1, T1>;
  ...
  T1 lagrange(const Input<T1>& input) const {
    const T1& q1 = A2D::get<0>(input);
    const T1& q2 = A2D::get<1>(input);
    const T1& q1dot = A2D::get<2>(input);
  ...
  void gradient(Input<T1>& input, Input<T1>& grad) const {
    A2D::ADObj<T1&> q1(A2D::get<0>(input), A2D::get<0>(grad));
    A2D::ADObj<T1&> q2(A2D::get<1>(input), A2D::get<1>(grad));
    A2D::ADObj<T1&> q1dot(A2D::get<2>(input), A2D::get<2>(grad));
    A2D::ADObj<T1&> q2dot(A2D::get<3>(input), A2D::get<3>(grad));
    A2D::ADObj<T1&> lam(A2D::get<4>(input), A2D::get<4>(grad));
  ...
  void hessian_product(Input<T1>& input, Input<T1>& dir, Input<T1>& grad,
                       Input<T1>& prod) const {
    A2D::A2DObj<T1&> q1(A2D::get<0>(input), A2D::get<0>(grad), A2D::get<0>(dir),
                        A2D::get<0>(prod));
    A2D::A2DObj<T1&> q2(A2D::get<1>(input), A2D::get<1>(grad), A2D::get<1>(dir),
                        A2D::get<1>(prod));
    A2D::A2DObj<T1&> q1dot(A2D::get<2>(input), A2D::get<2>(grad),
                           A2D::get<2>(dir), A2D::get<2>(prod));
    A2D::A2DObj<T1&> q2dot(A2D::get<3>(input), A2D::get<3>(grad),
                           A2D::get<3>(dir), A2D::get<3>(prod));
    A2D::A2DObj<T1&> lam(A2D::get<4>(input), A2D::get<4>(grad),
...
template <typename T>
class TimeVariableTrapezoidComponent {
 public:
  // The number of states
  template <typename T1>
  ...
  TimeVariableTrapezoidComponent() {}
