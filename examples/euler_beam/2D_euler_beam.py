...
model.add_component("src", 4, NodeSource())
...
model.link("src.u", "bcs.u", src_indices=[0])
model.link("src.v", "bcs.v", src_indices=[0])
model.link("src.t", "bcs.t", src_indices=[0])
...
def plot_disp(x, u=None, scale=5.0e4):
        """
